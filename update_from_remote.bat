...
curl.exe ^"https://6269176.techinfojoliette.ca:2083/cpsess5681528945/execute/VersionControl/update^" ^
  --compressed ^
  -X POST ^
  ...
  --data-raw ^"repository_root=^%%^2Fhome^%%^2Fu6269176^%%^2Frepositories^%%^2Ftp2_web2^&branch=main^"