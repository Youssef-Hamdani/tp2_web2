<section class="hero">
    <div>
        ...
        <h1>Achetez et vendez simplement, en français, avec un paiement Stripe.</h1>
        <p class="hero-copy">Chaque membre peut publier des articles, consulter les frais de service avant la mise en vente et acheter en ligne avec taxes québécoises calculées séparément.</p>
        <div class="hero-actions">
            ...
            <?php else: ?>
                ...
                <a class="button button-secondary" href="<?= e(url('/compte')) ?>">Voir mon tableau de bord</a>
            <?php endif; ?>
        </div>
    </div>
            ...
            <article class="product-card">
                ...
                <div class="product-card-body">
                    ...
                    <div class="card-actions">
                        ...
                        <?php if ($auth !== null && $auth->id !== $product->sellerUserId): ?>
